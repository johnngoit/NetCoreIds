...
namespace Common
{
	...
	{
		private RawCapture[] trafficDataForTest;

		public TestCaptureDevice()
		{
			...
			trafficDataForTest = new RawCapture[1] {capturedPacket};
		}

		public TestCaptureDevice(RawCapture[] trafficDataForTest)
		{
			this.trafficDataForTest = trafficDataForTest;
		}
		...
		{
			foreach (var capturedPacket in trafficDataForTest)
			{
		...
		public string LastError { get { throw new NotImplementedException(); } }

		public string Filter { get { throw new NotImplementedException(); } set { throw new NotImplementedException(); } }

		public ICaptureStatistics Statistics { get { throw new NotImplementedException(); } }

		public PhysicalAddress MacAddress { get { throw new NotImplementedException(); } }

		public bool Started { get { throw new NotImplementedException(); } }

		public TimeSpan StopCaptureTimeout { get { throw new NotImplementedException(); } set { throw new NotImplementedException(); } }

		public LinkLayers LinkType { get { throw new NotImplementedException(); } }
